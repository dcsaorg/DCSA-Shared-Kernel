package org.dcsa.skernel.pagination;
...
public class Paginator {
  ...
  private final Set<String> reservedArguments = Set.of("limit", "cursor");
  ...
  private String getRequestParameters(HttpServletRequest request, Set<String> allowedParameters) {
    ...
    request.getParameterMap().forEach((key, values) -> {
      if (!reservedArguments.contains(key) && (allowedParameters == null || allowedParameters.contains(key))) {
