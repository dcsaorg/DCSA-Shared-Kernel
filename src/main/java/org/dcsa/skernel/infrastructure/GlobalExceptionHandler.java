...
import org.dcsa.skernel.transferobjects.ConcreteRequestErrorMessageTO;
import org.dcsa.skernel.transferobjects.RequestFailureTO;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<RequestFailureTO> handleConcreteRequestErrorMessageException(
    HttpServletRequest httpServletRequest, ConcreteRequestErrorMessageException ex) {
  ...
  public ResponseEntity<RequestFailureTO> handle(
    HttpServletRequest httpServletRequest, InvalidDataAccessResourceUsageException ex) {
    return handleConcreteRequestErrorMessageException(
      httpServletRequest,
  ...
  public ResponseEntity<RequestFailureTO> handle(
    HttpServletRequest httpServletRequest, ServerWebInputException ex) {
    if (ex.getMessage() != null && ex.getMessage().contains("Invalid UUID string:")) {
      ...
      return handleDecodingExceptionImpl(httpServletRequest, (DecodingException) ex.getCause());
    } else if (ex.getCause() instanceof ConstraintViolationException) {
      return badRequest(httpServletRequest, (ConstraintViolationException) ex.getCause());
    } else {
      return handleConcreteRequestErrorMessageException(
        httpServletRequest,
  ...
  public ResponseEntity<RequestFailureTO> handleJsonDecodeException(
    HttpServletRequest httpServletRequest, DecodingException ce) {
    return handleDecodingExceptionImpl(httpServletRequest, ce);
  }
  ...
  private ResponseEntity<RequestFailureTO> handleDecodingExceptionImpl(
    ...
    if (ce.getCause() instanceof InvalidFormatException ife) {
  ...
  public ResponseEntity<?> handleDataIntegrityViolationException(
    HttpServletRequest httpServletRequest, DataIntegrityViolationException ex) {
  ...
  public ResponseEntity<?> handleAllExceptions(HttpServletRequest httpServletRequest, Exception ex) {
